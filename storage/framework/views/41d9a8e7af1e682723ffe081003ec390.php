...
<div class="container">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <a href="<?php echo e(route('filament.admin.pages.dashboard')); ?>" class="btn btn-outline-secondary">
  ...
  <div class="row g-4">
    ...
    <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="<?php echo e(100 + ($index * 50)); ?>">
...
<?php /**PATH /home/osama/asset/resources/views/welcome.blade.php ENDPATH**/ ?>